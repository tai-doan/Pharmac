...
const Export_Repay_Bill = ({ headerModal, detailModal, className, componentRef }) => {
            ...
            <div className='print-container'>
                <div className='page-break'>
                    ...
                    <div style={{ fontSize: '12pt', marginLeft: '10px' }}>
                        ...
                        <br />
                        <span style={{ marginTop: '20px', textAlign: 'right' }} ><b>{t('menu.supplier')}: </b>{headerModal.supplier ? headerModal.supplier : ''}</span>
                    </div>
                    <div>
                                    ...
                                    return (
                                        <React.Fragment key={index}>
                                            <tr key={index + 1} style={{ borderBottom: '1px solid #dfdfdf', padding: '5px 0px' }}>
                                                ...
                                                <td className='number' style={{ textAlign: 'right' }}>
                                                    {formatCurrency(!!details.o_8 ? details.o_8 : '')}
                                                </td>
                                                <td className='number' style={{ textAlign: 'right' }}>
                                                    {formatCurrency(!!details.o_9 ? details.o_9 : '')}
                                                </td>
                                                <td className='number' style={{ textAlign: 'right' }}>
...
export default Export_Repay_Bill
