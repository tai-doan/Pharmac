        ...
        return ( //partner.supplier.
            <>
                <div className="d-flex align-items-center justify-content-between mb-3">
                    <h6 className="font-weight-bold m-0">{t('partner.supplier.titleAdd')}</h6>
                </div>
                ...
                <div className="text-right mt-3">
                    <Link to="/page/partner/supplier" className="mr-3 normalLink">
