...
const SupplierView = ({ id, shouldOpenViewModal, handleCloseViewModal }) => {
    ...
    return (
        ...
        >
            <DialogTitle className="titleDialog pb-0">
                {t('partner.supplier.titleView', { name: Supplier.o_3 })}
            </DialogTitle>
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={6} sm={4}>
                        <TextField
                            ...
                            rows={1}
                            autoComplete="off"
                            label={t('partner.supplier.bank_nm')}
                            disabled={true}
                            value={Supplier.o_14 || ''}
                            name='o_14'
                            variant="outlined"
                    ...
                    <Grid item xs={6} sm={3}>
                        <Grid item xs={12} sm={12}>
                            <TextField
                                ...
                                autoComplete="off"
                                label={t('createdDate')}
                                value={moment(Supplier.o_21, 'DDMMYYYYHHmmss').format('DD/MM/YYYY HH:mm:ss')}
                                name="o_21"
                                variant="outlined"
                            />
                        </Grid>
