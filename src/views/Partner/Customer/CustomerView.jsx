    ...
    return (
        <>
            <div className="d-flex align-items-center justify-content-between mb-3">
                <h6 className="font-weight-bold m-0">{t('partner.customer.title')}</h6>
            ...
            <Tooltip title={t('partner.customer.titleAdd')} placement="top">
                <Link to="./ins-customer">
