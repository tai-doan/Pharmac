...
const tableCols = [
    ...
    { field: 'id', title: 'partner.customer.id', show: true, disabled: true, minWidth: 100 },
    { field: 'cust_nm_v', title: 'partner.customer.cust_nm_v', show: true, disabled: false, minWidth: 100 },
    { field: 'cust_nm_e', title: 'partner.customer.cust_nm_e', show: true, disabled: false, minWidth: 100 },
    {
        field: 'cust_nm_short',
        title: 'partner.customer.cust_nm_short',
        show: true,
        disabled: false,
        minWidth: 100,
        type: 'date',
    },
    { field: 'address', title: 'partner.customer.address', show: true, disabled: true, minWidth: 100 },
    { field: 'phone', title: 'partner.customer.phone', show: true, disabled: true, minWidth: 100 },
    { field: 'fax', title: 'partner.customer.fax', show: true, disabled: false, minWidth: 100 },
    { field: 'email', title: 'partner.customer.email', show: true, disabled: false, minWidth: 100 },
    { field: 'website', title: 'partner.customer.website', show: true, disabled: false, minWidth: 100, type: 'date' },
    { field: 'tax_cd', title: 'partner.customer.tax_cd', show: true, disabled: true, minWidth: 100 },
    { field: 'bank_acnt_no', title: 'partner.customer.bank_acnt_no', show: true, disabled: true, minWidth: 100 },
    { field: 'bank_acnt_nm', title: 'partner.customer.bank_acnt_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'bank_nm', title: 'partner.customer.bank_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'agent_nm', title: 'partner.customer.agent_nm', show: true, disabled: false, minWidth: 100, type: 'date' },
    { field: 'agent_fun', title: 'partner.customer.agent_fun', show: true, disabled: true, minWidth: 100 },
    { field: 'agent_address', title: 'partner.customer.agent_address', show: true, disabled: true, minWidth: 100 },
    { field: 'agent_phone', title: 'partner.customer.agent_phone', show: true, disabled: false, minWidth: 100 },
    { field: 'agent_email', title: 'partner.customer.agent_email', show: true, disabled: false, minWidth: 100 },
    {
        field: 'default_yn',
        title: 'partner.customer.default_yn',
        show: true,
        disabled: false,
        minWidth: 100,
        type: 'date',
            ...
            subcr_ClientReqRcv = socket_sv.event_ClientReqRcv.subscribe((message) => {
                if (message) {
                    ...
                    switch (reqInfoMap.reqFunct) {
                        case glb_sv.customer_FcntNm:
                            resultGetList(this.props, message, cltSeqResult, reqInfoMap)
                            break
                        case glb_sv.customer_del_FcntNm:
...
export default withTranslation()(enhance(CustomerView))
