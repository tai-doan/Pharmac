    ...
    return (
        <>
            <div className="d-flex align-items-center justify-content-between mb-3">
                <h6 className="font-weight-bold m-0">{t('report.warn_exp.title')}</h6>
                <div className="d-flex align-items-center">
                    <TextField
                        label={t('Tìm kiếm theo ID')}
                        value={valueSearchId}
                    ...
                    />
                    <TextField
                        label={t('Tìm kiếm theo số lô')}
                        value={valueSearchLot}
                        onChange={changeSearchLot}
                        autoComplete="off"
                        variant="outlined"
                        size="small"
                        type="search"
