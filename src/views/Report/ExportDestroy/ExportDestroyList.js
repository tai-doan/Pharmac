...
const ExportDestroyList = () => {
    ...
    useEffect(() => {
        getList(searchModal.start_dt, searchModal.end_dt, searchModal.reason_tp, searchModal.invoice_no, searchModal.invoice_status, searchModal.product_id, glb_sv.defaultValueSearch, glb_sv.defaultValueSearch);
    }, [])
    ...
    const getList = (startdate, endDate, reason_tp, invoice_no, invoice_status, product_id, last_invoice_id, last_invoice_detail_id) => {
        ...
        const inputParam = [startdate, endDate, reason_tp, invoice_no, invoice_status, product_id, last_invoice_id || glb_sv.defaultValueSearch, last_invoice_detail_id || glb_sv.defaultValueSearch]
