...
const UnitRate_Autocomplete = ({ onSelect, label, style, size, value, disabled = false }) => {
    ...
    useEffect(() => {
        ...
        const unitSub = socket_sv.event_ClientReqRcv.subscribe(msg => {
            if (msg) {
                ...
                if (reqInfoMap.reqFunct === reqFunction.UNIT_RATE_LIST) {
...
export default UnitRate_Autocomplete