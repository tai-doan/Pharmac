...
const tableListAddColumn = [
    ...
    { field: 'exp_tp', title: 'order.ins_export.exp_tp_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'prod_nm', title: 'order.ins_export.prod_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'lot_no', title: 'order.ins_export.lot_no', show: true, disabled: false, minWidth: 100 },
    { field: 'qty', title: 'order.ins_export.qty', show: true, disabled: true, minWidth: 100, align: 'right' },
    { field: 'unit_nm', title: 'order.ins_export.unit_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'price', title: 'order.ins_export.price', show: true, disabled: false, minWidth: 100, align: 'right' },
    { field: 'vat_per', title: 'order.ins_export.vat_per', show: true, disabled: false, minWidth: 100, align: 'right' },
    { field: 'discount_per', title: 'order.ins_export.discount_per', show: true, disabled: false, minWidth: 100, align: 'right' },
    { field: 'action', title: 'btn.delete', show: true, disabled: false, minWidth: 100, align: 'center' },
]

const tableListEditColumn = [
    { field: 'stt', title: 'stt', show: true, disabled: true, minWidth: 100, align: 'center' },
    { field: 'o_3', title: 'order.ins_export.exp_tp_nm', show: true, disabled: true, minWidth: 100 },
    { field: 'o_5', title: 'order.ins_export.prod_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'o_6', title: 'order.ins_export.lot_no', show: true, disabled: false, minWidth: 100 },
    { field: 'o_7', title: 'order.ins_export.qty', show: true, disabled: true, minWidth: 100, type: 'number', align: 'center' },
    { field: 'o_9', title: 'order.ins_export.unit_nm', show: true, disabled: true, minWidth: 100 },
    { field: 'o_10', title: 'order.ins_export.price', show: true, disabled: false, minWidth: 100, type: 'currency', align: 'right' },
    { field: 'o_11', title: 'order.ins_export.discount_per', show: true, disabled: false, minWidth: 100, type: 'currency', align: 'right' },
    { field: 'o_12', title: 'order.ins_export.vat_per', show: true, disabled: true, minWidth: 100, type: 'currency', align: 'right' },
