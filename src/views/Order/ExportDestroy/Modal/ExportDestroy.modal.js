...
const tableColumn = [
    ...
    { field: 'o_7', title: 'order.exportDestroy.cancel_reason', show: true, disabled: false, minWidth: 200 },
    { field: 'o_8', title: 'order.exportDestroy.note', show: true, disabled: false, minWidth: 100 },
    { field: 'o_9', title: 'order.exportDestroy.total_prod', show: true, disabled: false, minWidth: 100, type: 'number', align: 'right' },
    { field: 'o_10', title: 'order.exportDestroy.invoice_val', show: true, disabled: false, minWidth: 100, type: 'currency', align: 'right' },
    { field: 'o_11', title: 'updateUser', show: true, disabled: false, minWidth: 200 },
    { field: 'o_12', title: 'updateDate', show: true, disabled: false, minWidth: 100, type: 'date', align: 'center' }
]
