                ...
                <CardHeader
                    ...
                    action={
                        <div className='d-flex align-items-center'>
                            ...
                            <Chip onClick={() => history.push('/page/order/ins-exportDestroy')} size="small" className='mr-1' deleteIcon={<AddIcon />} onDelete={() => history.push('/page/order/ins-exportDestroy')} label={t('btn.add')} style={{ backgroundColor: 'var(--primary)', color: '#fff' }} />
                        </div>
                    }
                />
                <CardContent>
