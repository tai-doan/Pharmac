    ...
    return (
        <>
            <div className="d-flex align-items-center justify-content-between mb-3">
                <h6 className="font-weight-bold m-0">{t('order.import.title')}</h6>
            ...
            <Tooltip title={t('order.import.titleAdd')} placement="top">
                <Link to="./ins-export">
...
export default ExportOrderView
