...
import ExportOrderView from './ExportOrderView'
...
const tableCols = [
    ...
    { field: 'id', title: 'order.export.id', show: true, disabled: true, minWidth: 100 },
    { field: 'invoice_no', title: 'order.export.invoice_no', show: true, disabled: true, minWidth: 100 },
    { field: 'invoice_stat', title: 'order.export.invoice_stat', show: true, disabled: false, minWidth: 100 },
    { field: 'invoice_stat_nm  ', title: 'order.export.invoice_stat_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'cust_id', title: 'order.export.cust_id', show: true, disabled: false, minWidth: 100, type: 'date' },
    { field: 'cust_nm_v', title: 'order.export.cust_nm_v', show: true, disabled: true, minWidth: 100 },
    { field: 'input_dt', title: 'order.export.input_dt', show: true, disabled: true, minWidth: 100 },
    { field: 'staff_exp', title: 'order.export.staff_exp', show: true, disabled: false, minWidth: 100 },
    { field: 'staff_nm', title: 'order.export.staff_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'note  ', title: 'order.export.note', show: true, disabled: false, minWidth: 100, type: 'date' },
    { field: 'upd_user', title: 'order.export.upd_user', show: true, disabled: true, minWidth: 100 },
    { field: 'upd_date', title: 'order.export.upd_date', show: true, disabled: true, minWidth: 100 },
    { field: 'inv_values', title: 'order.export.inv_values', show: true, disabled: true, minWidth: 100 },
]
            ...
            subcr_ClientReqRcv = socket_sv.event_ClientReqRcv.subscribe((message) => {
                if (message) {
                    ...
                    switch (reqInfoMap.reqFunct) {
                        case glb_sv.exportOrder_FcntNm:
...
export default withTranslation()(enhance(ExportOrderView))
