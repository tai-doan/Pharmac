    ...
    return (
        <>
            <div className="d-flex align-items-center justify-content-between mb-3">
                <h6 className="font-weight-bold m-0">{t('order.export.title')}</h6>
            ...
            <Tooltip title={t('order.export.titleAdd')} placement="top">
                <Link to="./ins-import">
            ...
            >
                <DialogContent>
                    <DialogContentText className="m-0 text-dark">
                        {t('order.export.titleRemove', { name: name })}
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button
