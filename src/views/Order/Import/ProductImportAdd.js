...
const ProductImportAdd = ({ type = 'add', productInfoEdit = {}, handleAddProduct }) => {
    ...
    useEffect(() => {
        if (type === 'edit') {
            setProductInfo({ ...productInfoEdit })
        }
    }, [type])
    ...
    const handleSelectProduct = obj => {
        ...
        newProductInfo['prod_name'] = !!obj ? obj?.o_2 : ''
    ...
    const handleSelectUnit = obj => {
        ...
        newProductInfo['unit_name'] = !!obj ? obj?.o_2 : ''
        setProductInfo(newProductInfo)
    ...
    const checkValidate = () => {
        if (!!productInfo.imp_tp && !!productInfo.prod_id && !!productInfo.lot_no && !!productInfo.qty && !!productInfo.unit_id && !!productInfo.price && !!productInfo.discount_per && !!productInfo.vat_per) {
            return false
        }
        return true
    }
                        ...
                        <Grid item xs>
                            <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                <KeyboardDatePicker
                                    ...
                                    format="dd/MM/yyyy"
                                    id="made_dt-picker-inline"
                                    label={t('order.import.made_dt')}
                                    value={productInfo.made_dt}
