                    ...
                    <Grid container spacing={2}>
                        <Grid item xs>
                            <FormControl margin="dense" variant="outlined" className='w-100'>
                                <InputLabel id="exportRepay_type">{t('order.exportRepay.exportRepay_type')}</InputLabel>
                                <Select
                                    labelId="exportRepay_type"
                                    id="exportRepay_type-select"
                                    value={productInfo.imp_tp || '1'}
                                    onChange={handleChange}
                                    label={t('order.exportRepay.exportRepay_type')}
                                    name='imp_tp'
                                >
                                    <MenuItem value="1">{t('order.exportRepay.exportRepay_type_buy')}</MenuItem>
                                    <MenuItem value="2">{t('order.exportRepay.exportRepay_type_selloff')}</MenuItem>
                                </Select>
                            </FormControl>
                        </Grid>
                        <Grid item xs>
                        ...
                        <Grid item xs>
                            <MuiPickersUtilsProvider utils={DateFnsUtils}>
                                <KeyboardDatePicker
                                    ...
                                    label={t('order.exportRepay.exp_dt')}
