...
const tableListAddColumn = [
    ...
    { field: 'qty', title: 'order.ins_import.qty', show: true, disabled: true, minWidth: 100, align: 'right', type: 'number' },
    { field: 'unit_nm', title: 'order.ins_import.unit_nm', show: true, disabled: false, minWidth: 100 },
    { field: 'price', title: 'order.ins_import.price', show: true, disabled: false, minWidth: 100, align: 'right', type: 'number' },
