...
const serviceInfo = {
    ...
    ADD_PRODUCT_TO_INVOICE: {
        functionName: 'insert',
        reqFunct: reqFunction.PRODUCT_SETTLEMENT_IMPORT_INVOICE_CREATE,
        biz: 'import',
        object: 'imp_invoices_dt'
    },
    UPDATE_PRODUCT_TO_INVOICE: {
        functionName: 'update',
        reqFunct: reqFunction.PRODUCT_SETTLEMENT_IMPORT_INVOICE_UPDATE,
        biz: 'import',
        object: 'imp_invoices_dt'
    },
    DELETE_PRODUCT_TO_INVOICE: {
        functionName: 'delete',
        reqFunct: reqFunction.PRODUCT_SETTLEMENT_IMPORT_INVOICE_DELETE,
        biz: 'import',
        object: 'imp_invoices_dt'
    }
}
            ...
            if (msg) {
                ...
                switch (reqInfoMap.reqFunct) {
                    case reqFunction.SETTLEMENT_IMPORT_BY_ID:
                        ...
                        break
                    case reqFunction.PRODUCT_SETTLEMENT_IMPORT_INVOICE_CREATE:
                    ...
                    case reqFunction.GET_ALL_PRODUCT_BY_INVOICE_ID:
                        ...
                        break
                    case reqFunction.PRODUCT_SETTLEMENT_IMPORT_INVOICE_UPDATE:
                        resultActionProductToInvoice(msg, cltSeqResult, reqInfoMap)
                        break
                    default:
                        return
